...
namespace DemoQA_Selenium.Pages
{
    public class RegisterStudentPage : BasePage
    {
        ...
        private Element _gender(string gender) { return new Element(By.XPath($"//label[.='{gender}']")); }
        ...
        private Element _dayOfBirthValue(string month, string day) { return new Element(By.XPath($"//div[contains(@class,'day') and contains(@aria-label,'{month}') and .='{day}']")); }
        private Element _subjectsInput = new Element(By.XPath("//div[@id='subjectsContainer']//input"));
        private Element _hobbyOption(string hobby) { return new Element(By.XPath($"//label[text()='{hobby}']")); }
        ...
        private Element _stateOption(string state) { return new Element(By.XPath($"//div[text()='{state}']")); }
        ...
        private Element _modalData(string data) { return new Element(By.XPath($"//td[.='{data}']/following-sibling::td")); }
